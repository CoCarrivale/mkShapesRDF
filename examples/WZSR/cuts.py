...
# ----------------------------------
# lepton selections for WZ including loose id criteria
wz = '(nLepton>2 && Alt(Lepton_pt,3,0.)<10) \
     && ((abs(Alt(Lepton_pdgId,0,-9999))==11 && abs(Alt(Lepton_eta,0,-9999.))<2.5) || (abs(Alt(Lepton_pdgId,0,-9999))==13 && abs(Alt(Lepton_eta,0,-9999.))<2.4)) \
     && ((abs(Alt(Lepton_pdgId,1,-9999))==11 && abs(Alt(Lepton_eta,1,-9999.))<2.5) || (abs(Alt(Lepton_pdgId,1,-9999))==13 && abs(Alt(Lepton_eta,1,-9999.))<2.4)) \
     && ((abs(Alt(Lepton_pdgId,2,-9999))==11 && abs(Alt(Lepton_eta,2,-9999.))<2.5) || (abs(Alt(Lepton_pdgId,2,-9999))==13 && abs(Alt(Lepton_eta,2,-9999.))<2.4))'
#
