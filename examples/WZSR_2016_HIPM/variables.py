...
variables = {k:v for k,v in variables.items() if k in ['events','mjj','mll','mll_v1','mll_v2','ptl1','ptl2','ptj1','ptj2','mll_mjj_v2','mjj_detajj','mjj_v3', 'etaj1', 'etaj2', 'etal1', 'etal2']}
